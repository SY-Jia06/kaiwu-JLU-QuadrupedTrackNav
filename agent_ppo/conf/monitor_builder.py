...
def build_monitor():
    ...
    config_dict = (
        ...
        .add_panel(name="接近目标", name_en="reward_approach_goal", type="line")
            ...
            .end_panel()
        .add_panel(name="P6-启发式导航", name_en="reward_heuristic_navigation", type="line")
            .add_metric(metrics_name="reward_heuristic_navigation",
                        expr="avg(reward_heuristic_navigation{})")
            .end_panel()
        .add_panel(name="P6-死胡同逃脱", name_en="reward_deadend_escape", type="line")
            .add_metric(metrics_name="reward_deadend_escape",
                        expr="avg(reward_deadend_escape{})")
            .end_panel()
        .add_panel(name="P6-近墙减速", name_en="reward_wall_proximity_brake", type="line")
            .add_metric(metrics_name="reward_wall_proximity_brake",
                        expr="avg(reward_wall_proximity_brake{})")
            .end_panel()
        .end_group()
        # ==============================================================
        # Group 3: P6 navigation command diagnostics (not reward terms)
        # Group 3: P6 导航命令诊断（不参与 reward）
        # ==============================================================
        .add_group(group_name="导航诊断", group_name_en="navigation_diagnostics")
        .add_panel(name="P6-nav vx", name_en="nav_cmd_vx_mean", type="line")
            .add_metric(metrics_name="nav_cmd_vx_mean",
                        expr="avg(nav_cmd_vx_mean{})")
            .end_panel()
        .add_panel(name="P6-nav vy abs", name_en="nav_cmd_vy_abs_mean", type="line")
            .add_metric(metrics_name="nav_cmd_vy_abs_mean",
                        expr="avg(nav_cmd_vy_abs_mean{})")
            .end_panel()
        .add_panel(name="P6-nav wz abs", name_en="nav_cmd_wz_abs_mean", type="line")
            .add_metric(metrics_name="nav_cmd_wz_abs_mean",
                        expr="avg(nav_cmd_wz_abs_mean{})")
            .end_panel()
        .add_panel(name="P6-goal distance", name_en="nav_goal_dist_mean", type="line")
            .add_metric(metrics_name="nav_goal_dist_mean",
                        expr="avg(nav_goal_dist_mean{})")
            .end_panel()
        .add_panel(name="P6-target yaw abs", name_en="nav_target_yaw_abs_mean", type="line")
            .add_metric(metrics_name="nav_target_yaw_abs_mean",
                        expr="avg(nav_target_yaw_abs_mean{})")
            .end_panel()
        .end_group()
        .build()
    )
