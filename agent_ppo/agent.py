...
class Agent(BaseAgent):
    def __init__(self, agent_type="player", device="cuda", logger=None, monitor=None):
        ...
        # Keep the official proprio+scan convention, then append our compact
        # track goal features when the current stage declares them.
        self.num_obs = stage.num_proprio_obs + stage.num_scan + stage.num_goal_obs

        self._init_flat(stage)
